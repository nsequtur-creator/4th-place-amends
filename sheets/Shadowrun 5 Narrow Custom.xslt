...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:include href="xt.ConditionMonitor Narrow.xslt" />
  ...
  <xsl:include href="xt.Qualities Narrow.xslt" />
		  ...
		  <tr>
                    ...
                    <table class="tablestyle">
                      ...
                      <tr>
					    ...
					    <xsl:choose>
						  ...
						  <xsl:text>: </xsl:text><strong><xsl:value-of select="physicalcm" /></strong>
                         <br />
                          <xsl:value-of select="$lang.Overflow" />
						  <xsl:text>: </xsl:text><strong><xsl:value-of select="cmoverflow - 1" /></strong>
                        </td>
                        <td style="padding: 0.5em 0.5em 0.5em 0.5em;">
						  <xsl:choose>
							<xsl:when test="stuncmismatrixcm = 'True'">
							...
							<xsl:text>: </xsl:text><strong><xsl:value-of select="stuncm" /></strong>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 0.5em 0.5em 0.5em 0.5em;">
                        ...
                        <td style="padding: 0.5em 0.5em 0.5em 0.5em;">
                          <xsl:value-of select="$lang.StunNaturalRecovery" />: <xsl:value-of select="stuncmnaturalrecovery" />
                        </td>
                      </tr>
                    </table>
                  </div>
            ...
            <xsl:choose>
              <xsl:when test="mainmugshotbase64 != ''">
                  <td id="MainMugshotBlock" style="width: 33%; max-width: 33%; max-height: 100%; padding-left: 0.25em;">
          ...
          <tr>
            ...
            <table class="tablestyle" style="max-width: 100%;">
              ...
              <tr>
                ...
                <td width="16.67%">
                  <strong><xsl:value-of select="playername" /></strong>
                </td>
			  </tr>
			  <tr>
              ...
              <tr>
                <td width="33%">
                  <table width="100%">
                    ...
                    <xsl:call-template name="knowskills1" />
                  </table>
                </td>
                <td width="33%" style="border-left: solid 0.0625em #1c4a2d; border-right: solid 0.0625em #1c4a2d;">
                  <table width="100%">
                    ...
                    <xsl:call-template name="knowskills2" />
                  </table>
                </td>
                <td width="33%">
                  <table width="100%">
                    ...
                    <xsl:call-template name="knowskills3" />
                  </table>
                </td>
              </tr>
            </table>
                    ...
                    <table class="tablestyle">
                      <tr>
                        <th width="75%" style="text-align: left">
                          <xsl:value-of select="$lang.Positive" />&#160;<xsl:value-of select="$lang.Qualities" />
                        </th>
                        <th width="10%" />
                        <th width="15%" />
                      </tr>
                      <xsl:call-template name="Qualities">
						...
						<xsl:with-param name="condition" select="number(0)" />
                      </xsl:call-template>
                    </table>
                  </div>
                  </xsl:if>
                ...
                <td style="text-align: center; width: 50%;">
                  <xsl:if test="qualities/quality">
                    ...
                    <table class="tablestyle">
                      ...
                      <xsl:call-template name="Qualities">
						<xsl:with-param name="quality_type" select="'Positive'" />
						<xsl:with-param name="condition" select="number(1)" />
                      </xsl:call-template>
                    </table>
                  </div>
                  </xsl:if>
                    ...
                    <table class="tablestyle">
                      <tr>
                        <th width="80%" style="text-align: left">
                          <xsl:value-of select="$lang.Negative" />&#160;<xsl:value-of select="$lang.Qualities" />
                        </th>
                        <th width="5%" />
                        <th width="15%" />
                      </tr>
...
<!-- ** ** ** end of notes ** ** ** -->
  ...
  <xsl:template name="cyberware">
    <xsl:for-each select="cyberwares/cyberware[improvementsource = 'Cyberware']">
      <xsl:sort select="name" />
      <tr>
        <xsl:if test="position() mod 2 != 1">
          <xsl:attribute name="bgcolor">#e4e4e4</xsl:attribute>
        ...
        <tr>
          ...
          <td colspan="100%" class="indent">
            ...
            <xsl:for-each select="gears/gear">
              ...
              <tr>
                <th width="50%" style="text-align: left">
                  <xsl:value-of select="$lang.Bioware" />
                </th>
                <th width="20%"><xsl:value-of select="$lang.Essence" /></th>
                <th width="20%"><xsl:value-of select="$lang.Grade" /></th>
                <th width="10%" />
    ...
    <xsl:for-each select="cyberwares/cyberware[improvementsource = 'Bioware']">
      <xsl:sort select="name" />
      <tr>
        <xsl:if test="position() mod 2 != 1">
          <xsl:attribute name="bgcolor">#e4e4e4</xsl:attribute>
  ...
  <xsl:template name="gearplugin">
    ...
    <xsl:for-each select="children/gear[name !='Commlink Functionality']">
      <xsl:sort select="name" />
      <xsl:if test="qty != 1">
        <xsl:value-of select="qty" />
        <xsl:text>x </xsl:text>
